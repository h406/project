...
namespace PlayerStatus{
  ...
  const Status kStickBarStatus[] = {
    //                          重さ   慣性   速度   塗量
    {(int)StickBar::Normal,     1.0f,  1.0f,  7.0f,  0,"./data/model/bar.x"},
    {(int)StickBar::Elephant,   1.0f,  0.9f,  3.9f,  0,"./data/model/Elephant_bar.x"},
    {(int)StickBar::Bird,       0.2f,  0.22f, 6.5f,  0,"./data/model/Bird_bar.x"},
  ...
  const Status kStickHandleStatus[] = {
    //                          重さ   慣性   速度   塗量
    { (int)StickHandle::Normal, 1.0f,  1.0f,  8.0f,  3, "./data/model/hand.x" },
    {(int)StickHandle::Elephant,1.0f,  0.7f,  2.2f,  9,"./data/model/Elephant_handle.x"},
